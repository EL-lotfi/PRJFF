                    ...
                    <form wire:submit.prevent="submitSearch" class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <input type="search" wire:model.debounce.300ms="searchTerm" id="simple-search" class="flex-grow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:0jbg-gray-700 dark:0jborder-gray-600 dark:0jplaceholder-gray-400 dark:0jtext-white dark:0jfocus:ring-primary-500 dark:0jfocus:border-primary-500" placeholder="Search" >
                                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Search</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:0jtext-gray-400">
                    ...
                    @foreach($requetes as $requete)
                        <tr class="border-b dark:0jborder-gray-700">
                            ...
                            <td class="px-4 py-3">{{ $requete->version->dateVersion }}300</td>
