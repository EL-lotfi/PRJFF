                ...
                <div class="w-full md:w-1/2"> 
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="search" wire:model.debounce.300ms="searchTerm" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:0jbg-gray-700 dark:0jborder-gray-600 dark:0jplaceholder-gray-400 dark:0jtext-white dark:0jfocus:ring-primary-500 dark:0jfocus:border-primary-500" placeholder="Search" required="">
                        </div>
                    </form>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:0jtext-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:0jbg-gray-700 dark:0jtext-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Nom du Serveur</th>
